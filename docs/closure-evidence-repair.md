...
- **D. Visual capture (committed)**: T16 (`tests/e2e-browser/screenshots/admin/users/{users-after-invite.png, users-expanded.png, users-self-invite-error.png, users-self-row-disabled.png}`) and T17 (`tests/e2e-browser/screenshots/admin/topics/{topics-after-approve.png, topics-after-reject.png, topics-after-retire.png, topics-expanded.png, topics-retire-confirm.png, topics-self-action-disabled.png}`) have their committed-baseline PNGs on disk. T18 (`tests/e2e-browser/screenshots/admin/status/{status-expanded.png, status-expanded-desktop.png, status-expanded-tablet.png, status-expanded-mobile.png, status-warning.png, status-tokens-needing-refresh.png}`) and T19 (`tests/e2e-browser/screenshots/admin/end-toend-*.png`) baselines are recorded in `tests/e2e-browser/screenshots/admin/status/CLOSURE_SUMMARY.md` and `tests/e2e-browser/screenshots/admin/end-to-end-CLOSURE_SUMMARY.md` but the PNGs themselves have not all been committed yet; the Admin Status section's PNG capture is a pending follow-up.
